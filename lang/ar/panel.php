...
return [
    ...
    'excel_category' => 'معرف الفئة',
    'excel_category_hint' => 'انسخ المعرف من ورقة «الفئات» داخل هذا الملف. اسم الفئة نفسه مستخدم في كل الدول، فالاسم وحده لا يحدد الفئة المقصودة — المعرف وحده يحددها.',
